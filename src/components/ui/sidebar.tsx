...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0 lets this shrink below its content's intrinsic width — it's
        // a flex item in the sidebar row, and flex items default to min-width:
        // auto, which otherwise forces the whole page to scroll horizontally.
